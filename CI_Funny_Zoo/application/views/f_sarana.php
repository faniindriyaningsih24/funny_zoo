<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="asset/template/t_sarana2.css">
  ...
  <body>
        ...
        <header>
          ...
          <div id='cssmenu' style="position:absolute; top:0px; right:10px;z-index:2;">
              ...
              <!--FASILITAS-->
                <li class='has-sub active'><a href='#'><span><b>FASILITAS</b></span></a>
                  <ul>
    ...
    <div id="isi2">
        ...
        ?>
        	<div id="bagan">
            <div class="judul"><h1><?php echo $sarana->judul_sarana ?></h1></div>
          	<img src="http://localhost/funny_zoo/images/sarana/<?= $sarana->foto_sarana; ?>" style="width:200px; height:200px;">
          	
          	<div class="hasil">
          	<?php echo $sarana->isi_sarana ?>
          	</div>
          	</div>
        <?php
        }
