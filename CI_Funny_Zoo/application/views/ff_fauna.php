<html>
  ...
  <body>
    ...
    <!--KONTEN KE-2 -->
    <div id="konten2">
       <div id="isi2" style=" height:1900px; background-color:white;">
        <?php
        foreach ($fauna as $fauna) {
        ?>
        <div id="gambar">
          <img src="http://localhost/funny_zoo/images/fauna/<?= $fauna->foto_fauna; ?>" style="width:190px; height:150px;">
        <div id="deskripsi"><strong>
          <?php 
          echo $fauna->judul_fauna;
          ?>
        </strong></div>
        </div>
        <?php
    ...
    <div id="info"style=" margin-top: 900px;">
      <div id="info1">
        <!--TIKET-->
      <div id="subinfo">
