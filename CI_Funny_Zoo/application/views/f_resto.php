<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="asset/template/t_resto1.css">
  ...
  <body>
    ...
    <div id="konten2">
      ...
      <div style="">
    <div>
      <img src="http://localhost/funny_zoo/images/fasilitas/<?= $resto->foto_fasilitas ?>" 
