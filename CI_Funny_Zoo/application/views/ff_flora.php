<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="asset/template/t_fauna2.css">
  ...
  <body>
        ...
        <header>
          ...
          <div id='cssmenu' style="position:absolute; top:0px; right:10px;z-index:2;">
              <ul>
                ...
                <!--FLORA & FAUNA-->
                <li class='has-sub active'><a href='#'><span><b>FLORA & FAUNA</b></span></a>
                  <ul>
    ...
    <!--KONTEN KE-2 -->
    <div id="konten2">
       <div id="isi2" style=" height:1000px; background-color:white;">
        <?php
        foreach ($flora as $flora) {
        ?>
        <div id="gambar" style="margin-top:25px">
          <img src="http://localhost/funny_zoo/images/flora/<?= $flora->foto_flora; ?>" style="width:190px; height:150px;">
        <div id="deskripsi"><strong>
          <?php 
          echo $flora->judul_flora;
          ?>
        </strong></div>
        </div>
        <?php
    ...
    <!--KUMPULAN INFORMASI ==> TICKET, JADWAL, ARAH -->
     <div id="info" style="margin-top:0px;">
      <div id="info1">
        <!--TIKET-->
      <div id="subinfo">
