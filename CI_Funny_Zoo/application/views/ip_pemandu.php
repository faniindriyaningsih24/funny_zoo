<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="asset/template/t_pemandu1.css">
  ...
  <body>
        ...
        <header>
          ...
          <div id='cssmenu' style="position:absolute; top:0px; right:10px;z-index:2;">
              <ul>
                ...
                <!--INFO PENGUNJUNG-->
                 <li class='has-sub active'><a href='#'><span><b>INFO PENGUNJUNG</b></span></a>
                  <ul>
    ...
    <div id="konten2">
      ...
      <div style="">
    <div>
      <img src="http://localhost/funny_zoo/images/ip/<?= $pemandu->foto_ip ?>" 
