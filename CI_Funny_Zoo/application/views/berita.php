<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="asset/template/t_berita1.css">
  ...
  <body>
        ...
        <header>
          ...
          <div id='cssmenu' style="position:absolute; top:0px; right:10px;z-index:2;">
              ...
              <!--FASILITAS-->
                ...
                <!--BERITA & ACARA-->
                <li class='has-sub active'><a href="<?php echo site_url ('berita') ; ?>"><span><b>BERITA & ACARA</b></span></a>
                </li>
                <!--PROMO-->
    ...
    <div id="isi2">
        ...
        ?>
        	<div id="bagan">
            <div class="judul"><h1><?php echo $berita->judul_berita ?></h1></div>
          	<img src="http://localhost/funny_zoo/images/berita/<?= $berita->foto_berita; ?>" style="width:350px; height:200px;">
