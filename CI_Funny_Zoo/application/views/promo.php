<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="asset/template/t_promo.css">
  ...
  <body>
        ...
        <!--MENU-->
          <div id='cssmenu' style="position:absolute; top:0px; right:10px;z-index:2;">
              ...
              <!--FASILITAS-->
                ...
                <!--PROMO-->
                <li class="active"><a href="<?php echo site_url ('promo') ; ?>"><span><b>PROMO</b></span></a></li>
              </ul>
            </div>
    ...
    <div id="isi2">
        ...
        ?>
        	<div id="bagan">
          	<img src="http://localhost/funny_zoo/images/promo/<?= $promo->foto_promo; ?>" style="width:550px; height:700px;">
